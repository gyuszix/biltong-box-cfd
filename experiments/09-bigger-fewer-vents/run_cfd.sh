#!/usr/bin/env bash
# Mesh + solve the big_vents_lengthwise variant with OpenFOAM, via Docker.
#
# Usage:
...
VARIANT="${1:-}"
case "$VARIANT" in
    big_vents_lengthwise) CASE_DIR="case-big-vents-lengthwise" ;;
    *)
        echo "Usage: $0 <big_vents_lengthwise>" >&2
        exit 1
        ;;
esac
