#!/usr/bin/env python3
"""
Generate the OpenFOAM case files (0/, constant/, system/) for experiment 7's
"long_vents_lengthwise" variant, and copy in the matching STL patches from
stl_out/long_vents_lengthwise/.
...
and fan position as experiment 4's end_mount, same rod orientation as
experiment 5's rods_lengthwise, same vent placement as experiment 6's
long_face_vents - this variant stacks all three. See generate_geometry_v2.py
for the box/fan/vent geometry these numbers are derived from.
"""
...
VARIANTS = {
    "long_vents_lengthwise": {
        "case_dir": os.path.join(ROOT, "case-long-vents-lengthwise"),
...
def main():
    ...
    print("\nDone. Next: ./run_cfd.sh long_vents_lengthwise")
