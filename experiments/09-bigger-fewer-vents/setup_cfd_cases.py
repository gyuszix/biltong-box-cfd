#!/usr/bin/env python3
"""
Generate the OpenFOAM case files (0/, constant/, system/) for experiment 9's
"big_vents_lengthwise" variant, and copy in the matching STL patches from
stl_out/big_vents_lengthwise/.
...
so the assumptions are all in one place. Identical fan/air/turbulence
assumptions, fan position, and rod orientation to experiment 7's
long_vents_lengthwise and experiment 8's fewer_vents_lengthwise - only the
vent hole diameter changes (21.21mm instead of 15mm, at exp8's reduced
6-hole count; see generate_geometry_v2.py for the geometry difference).
"""
...
VARIANTS = {
    "big_vents_lengthwise": {
        "case_dir": os.path.join(ROOT, "case-big-vents-lengthwise"),
...
def main():
    ...
    print("\nDone. Next: ./run_cfd.sh big_vents_lengthwise")
