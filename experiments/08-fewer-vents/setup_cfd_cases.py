#!/usr/bin/env python3
"""
Generate the OpenFOAM case files (0/, constant/, system/) for experiment 8's
"fewer_vents_lengthwise" variant, and copy in the matching STL patches from
stl_out/fewer_vents_lengthwise/.
...
long_vents_lengthwise - only the vent hole count changes (3 per long face
instead of 6; see generate_geometry_v2.py for the geometry difference).
"""
...
VARIANTS = {
    "fewer_vents_lengthwise": {
        "case_dir": os.path.join(ROOT, "case-fewer-vents-lengthwise"),
...
def main():
    ...
    print("\nDone. Next: ./run_cfd.sh fewer_vents_lengthwise")
