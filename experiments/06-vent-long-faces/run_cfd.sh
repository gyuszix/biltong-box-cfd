#!/usr/bin/env bash
# Mesh + solve the long_face_vents variant with OpenFOAM, via Docker.
#
# Usage:
#   ./run_cfd.sh long_face_vents
#
...
VARIANT="${1:-}"
case "$VARIANT" in
    long_face_vents) CASE_DIR="case-long-face-vents" ;;
    *)
        echo "Usage: $0 <long_face_vents>" >&2
        exit 1
        ;;
esac
