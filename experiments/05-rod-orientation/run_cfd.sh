#!/usr/bin/env bash
# Mesh + solve the rods_lengthwise variant with OpenFOAM, via Docker.
#
# Usage:
#   ./run_cfd.sh rods_lengthwise
#
...
VARIANT="${1:-}"
case "$VARIANT" in
    rods_lengthwise) CASE_DIR="case-rods-lengthwise" ;;
    *)
        echo "Usage: $0 <rods_lengthwise>" >&2
        exit 1
        ;;
esac
