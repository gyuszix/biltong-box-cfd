#!/usr/bin/env bash
# Mesh + solve the long_vents_lengthwise variant with OpenFOAM, via Docker.
#
# Usage:
...
VARIANT="${1:-}"
case "$VARIANT" in
    long_vents_lengthwise) CASE_DIR="case-long-vents-lengthwise" ;;
    *)
        echo "Usage: $0 <long_vents_lengthwise>" >&2
        exit 1
        ;;
esac
